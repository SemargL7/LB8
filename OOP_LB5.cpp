...
class TypeP : public Strategy
{
public:
    void type() {
        cout << "Type of drugs is Powder" << endl;
    }
};

class TypeT : public Strategy
{
public:
    void type() {
        cout << "Type of drugs is Pills" << endl;
    }
};
...
public:
    PFM() {}
    PFM(char n[], int l, int w, int h) {
        strcpy(name, n); this->l = l; this->w = w; this->h = h;
    }
    ~PFM() {}

    void setStrategy(Strategy* strategy) { this->strategy = strategy; }

    void Type() { strategy->type(); }
...
private:
    int weight;
public:
    PFM_T() :PFM() { setStrategy(new TypeT); }
    PFM_T(char n[], int l, int w, int h, int wT) :PFM(n, l, w, h), weight(wT) { setStrategy(new TypeT); }
    ~PFM_T() {}
...
private:
    int weight;
public:
    PFM_P() :PFM() { setStrategy(new TypeP); }
    PFM_P(char n[], int l, int w, int h, int wT) :PFM(n, l, w, h), weight(wT) { setStrategy(new TypeP); }
    ~PFM_P() {}
